...
describe('platformSkins', () => {
  ...
  test('maps console families', () => {
    ...
    expect(familyForPlatform('GAME_WATCH')).toBe('nintendo')
    ...
    expect(familyForPlatform('BBC_MICRO')).toBe('pc')
  ...
  test('applyPlatformSkin sets document attributes', () => {
    ...
    expect(document.documentElement.style.getPropertyValue('--od-platform-accent')).toBe('#e60012')
    clearPlatformSkin()
