...
export async function fetchLibraryPlatforms({ signal } = {}) {
...
export async function fetchLicensedCatalog({ libraryPlatform, signal } = {}) {
...
export async function fetchSetCompletion({ libraryPlatform, region, signal } = {}) {
