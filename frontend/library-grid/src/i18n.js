const STRINGS = {
  en: {
    ...
    Library: 'Library',
    'Library platform': 'Library platform',
    'IGDB platform': 'IGDB platform',
    Genre: 'Genre',
    Theme: 'Theme',
    'Game mode': 'Game mode',
    'Player perspective': 'Player perspective',
    'All Libraries': 'All Libraries',
    'All Library Platforms': 'All Library Platforms',
    'All IGDB Platforms': 'All IGDB Platforms',
  ...
  es: {
    ...
    Library: 'Biblioteca',
    'Library platform': 'Plataforma de biblioteca',
    'IGDB platform': 'Plataforma IGDB',
    Genre: 'Género',
    Theme: 'Tema',
    'Game mode': 'Modo de juego',
    'Player perspective': 'Perspectiva',
    'All Libraries': 'Todas las bibliotecas',
    'All Library Platforms': 'Todas las plataformas',
    'All IGDB Platforms': 'Todas las plataformas IGDB',
