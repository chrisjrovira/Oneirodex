import type { OpsRow } from './opsWidgets'

/* Formatting, tone and normalisation helpers moved out of opsWidgets (v11 cycle, H-D.2) — unchanged. */
...
/**
 * Banner tone from items when present: an action row → bad; else soft → warn; else fallback.
 */
