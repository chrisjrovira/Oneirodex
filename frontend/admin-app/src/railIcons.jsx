/**
 * Glyphs for every rail destination (GT-B3) — admin copy.
 *
 * Generated by the same script as the member-app file rather than shared via
 * frontend/shared, which has to be staged explicitly in the Dockerfile and
 * broke the image build once already.
 *
