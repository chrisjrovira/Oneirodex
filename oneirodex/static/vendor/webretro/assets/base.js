...
// Prefer admin-uploaded BIOS under Oneirodex static; missing files fail soft (biosReady still set).
...
// Oneirodex A/V tuning: WASM audio scheduling (Web Audio + emscripten main
...
function initFromData(data) {
	// Standalone webretro warns on tab close. Inside the Oneirodex play shell
