...
$(document).ready(function() {
    ...
    // Map fragments to tab IDs (include nested Artwork / Metadata anchors used
    // by Integrations inventory deep links).
    const fragmentTabMap = {
        ...
        '#artwork': 'artwork-tab',
        '#steamgriddb': 'artwork-tab',
        '#giantbomb': 'artwork-tab',
        '#mobygames': 'artwork-tab',
        '#thegamesdb': 'artwork-tab',
        '#hltb': 'artwork-tab',
        '#meta_quest': 'artwork-tab',
        '#ownership': 'artwork-tab',
        '#livekit': 'artwork-tab',
        '#support': 'artwork-tab',
        '#indexers': 'artwork-tab',
        '#oidc': 'oidc-tab'
    };
