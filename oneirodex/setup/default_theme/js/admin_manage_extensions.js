...
function updateTableWithNewData(category, data) {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <button type="button" class="btn btn-sm btn-warning" data-od-click="editFileType">
                <i class="fas fa-edit"></i>
            </button>
            <button type="button" class="btn btn-sm btn-danger" data-od-click="deleteFileType" data-od-arg="${category}" data-od-arg2="${data.id}">
