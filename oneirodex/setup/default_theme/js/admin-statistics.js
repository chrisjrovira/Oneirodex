...
function odRenderTotals(totals) {
    if (!totals) return;
...
function odRenderTopGamesTable(rows) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('/admin/statistics/data')
        ...
        .then(data => {
            odRenderTotals(data.totals);
            odRenderTopGamesTable(data.top_games_table);
