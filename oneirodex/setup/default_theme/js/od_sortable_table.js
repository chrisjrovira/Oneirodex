 ...
 *
 *     <table data-od-sortable data-od-sort-default="folder" data-od-sort-dir="asc">
 *
...
(function (global) {
    ...
    function enhance(table) {
        if (!table || table.__odSortable) return null;
        ...
        var defaultKey = table.getAttribute('data-od-sort-default');
        if (defaultKey) {
            state = {
                key: defaultKey,
                dir: table.getAttribute('data-od-sort-dir') === 'desc' ? 'desc' : 'asc',
            };
        }
        ...
        function updateIndicators() {
            for (var i = 0; i < headers.length; i++) {
                ...
                var button = entry.th.querySelector('.od-sort-btn');
                var mark = entry.th.querySelector('.od-sort-btn__ind');
        ...
        table.__odSortable = api;
        return api;
    }

    function enhanceAll(root) {
        var scope = root || document;
        var tables = scope.querySelectorAll('table[data-od-sortable]');
        var made = [];
