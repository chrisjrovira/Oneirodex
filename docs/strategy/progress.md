...
| UID-017 / UID-018 | Token remainder is hex brand/warn colours plus fluid `clamp()` type (**159** on the ratchet) · envelope remainder (**41** annotated keeps) |
