...
| UID-017 / UID-018 | Token remainder is platform brand hex plus fluid `clamp()` type (**21** on the ratchet) · envelope remainder (**41** annotated keeps) |
