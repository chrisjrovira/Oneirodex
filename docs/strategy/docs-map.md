...
| UI debt log | Have — [dev/ui-debt-log.md](../dev/ui-debt-log.md) — open table is the living register; older changelog in [dev/archive/ui-debt-changelog-2026-08.md](../dev/archive/ui-debt-changelog-2026-08.md) |
