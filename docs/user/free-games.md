...
|---|---|
| **News → Free now** | Active offers with Claim, Open in app, Sync ownership |
| **Notifications** | `Free on …` alerts for newly seen offers (opt out under Notification preferences) |
