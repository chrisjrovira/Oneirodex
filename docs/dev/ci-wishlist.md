...
- [A2.4-cheats-client] `tests/test_pydantic_cheats_client.py` added to the
  `pytest-core` hand list (PC-cheat label / companion lifecycle records
  `@validate_body` 422 contracts).
