...
- [A2.4-arr-json] `tests/test_pydantic_arr.py` added to the `pytest-core`
  hand list (Arr download / hardlink-preview `@validate_body` 422
  contracts). `tests/test_ops_followons.py` was already on the list.
