...
| **run-oneirodex** | "run it", "screenshot it", "does this work in the real app?" | Launches uvicorn against the test DB, logs in, calls the JSON API, screenshots the SPAs in Chromium |
