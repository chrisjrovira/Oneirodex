...
| **Maintainers / post-1.0 handoff** | [HANDOFF.md](HANDOFF.md) — cold-start brief for the agent taking over after the v1 cycle: what shipped, what blocks the `v1.0.0` tag, the eleven items still waiting on a human |
