...
- Persist base URL in file store; API token in OS credential store (keychain adapter).
...
## Non-goals
DRM store download queues, bundled torrent/debrid marketplace, full Tauri install pipeline.
