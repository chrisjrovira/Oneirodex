...
```json
{
  ...
  "host": {
    ...
    "disk_warez": { "total": 0, "used": 0, "free": 0, "percent": 0 },
  ...
  "issues": {
    ...
    "items": [
      { "id": "disk_warez_high", "severity": "warn", "message": "Warez disk 87% used", "href": "/admin/ops" }
    ]
  },
  "scans": {
    "active_count": 0,
...
| Condition | Severity |
|-----------|----------|
| Disk base or warez ≥ 95% | bad |
| Disk base or warez ≥ 85% | warn |
