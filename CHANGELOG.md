...
- **More small sheets use radius and type tokens.** Scan conflict, Open path, Propose leaves, Command palette, Chat slide-out, store links, library selection bar, DataTable, game preview, and glass chrome. Token ratchet **1195 → 1124**. Member SPA needs an image rebuild.
