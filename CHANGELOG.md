...
### Changed
- Check-username and layout-preset create adopt `@validate_body`. Missing `username` or `name`/`layout` are now `422 unprocessable`. Unknown section ids and the 64-character preset name cap still 400 from the helper.
