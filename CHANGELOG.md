...
### Changed
- Art-studio preview/generate/apply adopt `@validate_body`. Missing `title` / `pack_id` is now `422 unprocessable`. Mode-dependent apply checks and disk errors stay in the view.
