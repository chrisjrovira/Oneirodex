"""
Unit tests for gametheca.routes_admin_ext.invites
...
class TestManageInvitesGet:
    ...
    @patch('gametheca.routes_admin_ext.invites.render_template')
...
class TestManageInvitesEdgeCases:
    ...
    def test_database_error_handling_get(self, mock_render, client, admin_user, regular_user, monkeypatch):
        ...
        with patch('gametheca.routes_admin_ext.invites.select') as mock_select:
