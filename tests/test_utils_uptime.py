...
class TestGetFormattedSystemUptime:
    ...
    @patch('oneirodex.utils.uptime.get_system_uptime', return_value=3661)
    ...
    @patch('oneirodex.utils.uptime.get_system_uptime', return_value=None)
    ...
    @patch('oneirodex.utils.uptime.get_system_uptime', return_value=30)
