...
class TestGetFormattedSystemUptime:
    ...
    @patch('gametheca.utils.uptime.get_system_uptime', return_value=3661)
    ...
    @patch('gametheca.utils.uptime.get_system_uptime', return_value=None)
    ...
    @patch('gametheca.utils.uptime.get_system_uptime', return_value=30)
