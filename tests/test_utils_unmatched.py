...
from gametheca.models import UnmatchedFolder, Library, ScanJob
...
def sample_library(db_session):
    ...
    from gametheca.models import LibraryPlatform
    library = Library(
        uuid=str(uuid4()),
        name='Test Library',
...
class TestHandleDeleteUnmatchedOnly:
    ...
    @patch('gametheca.utils.unmatched.log_system_event')
    @patch('gametheca.utils.unmatched.redirect')
    @patch('gametheca.utils.unmatched.url_for')
    @patch('gametheca.utils.unmatched.flash')
    @patch('gametheca.utils.unmatched.logger')
    ...
    @patch('gametheca.utils.unmatched.log_system_event')
    @patch('gametheca.utils.unmatched.db.session.execute')
    @patch('gametheca.utils.unmatched.redirect')
    @patch('gametheca.utils.unmatched.url_for')
    @patch('gametheca.utils.unmatched.flash')
    @patch('gametheca.utils.unmatched.logger')
