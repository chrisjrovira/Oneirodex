...
class TestGetOrCreateSettingsRecord:
    ...
    def test_get_existing_settings_record(self, db_session, global_settings):
        ...
        with patch('gametheca.routes_admin_ext.settings.db.session', db_session):
...
class TestSettingsRoutes:
    ...
    @patch('gametheca.routes_admin_ext.settings.log_system_event')
    @patch('gametheca.routes_admin_ext.settings.cache.delete')
    ...
    @patch('gametheca.routes_admin_ext.settings.db.session.commit')
...
class TestSettingsIntegration:
    ...
    def test_settings_persistence(self, client, admin_user, db_session, clean_settings):
        ...
        with patch('gametheca.routes_admin_ext.settings.log_system_event'), \
             patch('gametheca.routes_admin_ext.settings.cache.delete'):
