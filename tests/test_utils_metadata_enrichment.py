"""Tests for oneirodex.utils.metadata_enrichment.apply_enriched_metadata.
...
@patch('oneirodex.utils.metadata_enrichment._attach_named_relations', side_effect=RuntimeError('boom'))
@patch('oneirodex.utils.metadata_enrichment.db.session.begin_nested')
...
def test_apply_enriched_metadata_rolls_back_on_error(app, db_session):
    ...
    from oneirodex.models import Library, Game
    ...
    with patch('oneirodex.utils.metadata_enrichment._attach_named_relations', side_effect=boom):
