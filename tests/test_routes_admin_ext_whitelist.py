"""
Unit tests for gametheca.routes_admin_ext.whitelist
...
class TestWhitelistRoutes:
    ...
    @patch('gametheca.routes_admin_ext.whitelist.log_system_event')
    ...
    def test_whitelist_post_handles_database_error(self, mock_log, client, db_session, admin_user):
        ...
        # Mock database error
        with patch('gametheca.routes_admin_ext.whitelist.db.session.commit', side_effect=Exception('Database error')):
            response = client.post('/admin/whitelist', data={
