"""
Unit tests for oneirodex.routes_admin_ext.whitelist
...
from oneirodex.models import Whitelist, User
...
class TestWhitelistRoutes:
    ...
    def test_whitelist_post_handles_database_error(self, mock_log, client, db_session, admin_user):
        ...
        # Mock database error
        with patch('oneirodex.routes_admin_ext.whitelist.db.session.commit', side_effect=Exception('Database error')):
            response = client.post('/admin/whitelist', data={
