...
class TestSMTPTesterConnection:
    ...
    @patch('oneirodex.utils.smtp_test.log_system_event')
    @patch('oneirodex.utils.smtp_test.socket.create_connection')
    @patch('oneirodex.utils.smtp_test.smtplib.SMTP')
    ...
    @patch('oneirodex.utils.smtp_test.socket.create_connection')
    @patch('oneirodex.utils.smtp_test.smtplib.SMTP')
    @patch('oneirodex.utils.smtp_test.ssl.create_default_context')
    ...
    def test_connection_debug_mode(self, tester):
        ...
        with patch('oneirodex.utils.smtp_test.socket.create_connection') as mock_socket, \
             patch('oneirodex.utils.smtp_test.smtplib.SMTP') as mock_smtp_class:
...
class TestMainFunction:
    ...
    @patch('oneirodex.utils.smtp_test.SMTPTester')
    @patch('oneirodex.utils.smtp_test.sys.argv', ['smtp_test.py', '--host', 'smtp.example.com', '--port', '587'])
    ...
    @patch('oneirodex.utils.smtp_test.SMTPTester')
    @patch('oneirodex.utils.smtp_test.getpass', return_value='testpass')
    @patch('oneirodex.utils.smtp_test.sys.argv', [
    ...
    @patch('oneirodex.utils.smtp_test.SMTPTester')
    @patch('oneirodex.utils.smtp_test.getpass')
    @patch('oneirodex.utils.smtp_test.sys.argv', [
        'smtp_test.py', '--host', 'smtp.example.com', '--port', '587',
        '--username', 'testuser'
    ])
    ...
    @patch('oneirodex.utils.smtp_test.sys.argv', ['smtp_test.py', '--host', 'smtp.example.com', '--port', '587', '--timeout', '30'])
    @patch('oneirodex.utils.smtp_test.SMTPTester')
