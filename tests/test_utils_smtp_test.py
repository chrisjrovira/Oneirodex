...
from gametheca.utils.smtp_test import SMTPTester, main
...
class TestSMTPTesterConnection:
    ...
    @patch('gametheca.utils.smtp_test.log_system_event')
    @patch('gametheca.utils.smtp_test.socket.create_connection')
    @patch('gametheca.utils.smtp_test.smtplib.SMTP')
    ...
    @patch('gametheca.utils.smtp_test.socket.create_connection')
    @patch('gametheca.utils.smtp_test.smtplib.SMTP')
    @patch('gametheca.utils.smtp_test.ssl.create_default_context')
    ...
    def test_connection_debug_mode(self, tester):
        ...
        with patch('gametheca.utils.smtp_test.socket.create_connection') as mock_socket, \
             patch('gametheca.utils.smtp_test.smtplib.SMTP') as mock_smtp_class:
...
class TestMainFunction:
    ...
    @patch('gametheca.utils.smtp_test.SMTPTester')
    @patch('gametheca.utils.smtp_test.sys.argv', ['smtp_test.py', '--host', 'smtp.example.com', '--port', '587'])
    ...
    @patch('gametheca.utils.smtp_test.SMTPTester')
    @patch('gametheca.utils.smtp_test.getpass', return_value='testpass')
    @patch('gametheca.utils.smtp_test.sys.argv', [
    ...
    @patch('gametheca.utils.smtp_test.SMTPTester')
    @patch('gametheca.utils.smtp_test.getpass')
    @patch('gametheca.utils.smtp_test.sys.argv', [
        'smtp_test.py', '--host', 'smtp.example.com', '--port', '587',
        '--username', 'testuser'
    ])
    ...
    @patch('gametheca.utils.smtp_test.sys.argv', ['smtp_test.py', '--host', 'smtp.example.com', '--port', '587', '--timeout', '30'])
    @patch('gametheca.utils.smtp_test.SMTPTester')
