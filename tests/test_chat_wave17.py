...
from oneirodex.utils.chat import ALLOWED_REACTIONS, MENTION_RE
...
def test_wave17_helpers_importable():
    from oneirodex.utils.chat import search_messages, toggle_reaction
...
def test_chat_reaction_model_importable():
    from oneirodex.models import ChatMessageReaction
