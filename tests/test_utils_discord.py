...
from gametheca.models import Library, GlobalSettings, Game, GameURL
from gametheca.platform import LibraryPlatform
from gametheca.utils.discord import (
...
class TestDiscordWebhook:
    ...
    @patch('gametheca.utils.discord.get_cover_url')
    @patch('gametheca.utils.discord.format_size')
    @patch('gametheca.utils.discord.DiscordWebhook')
    @patch('gametheca.utils.discord.DiscordEmbed')
...
class TestGetGameByFullDiskPath:
    ...
    @patch('gametheca.utils.discord.db.session.execute')
