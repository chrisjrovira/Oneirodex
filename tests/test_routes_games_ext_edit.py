...
class TestGameEditSecurityValidation:
    ...
    def test_path_validation_prevents_traversal(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path') as mock_safe_path:
            mock_safe_path.return_value = (False, "Access denied - path outside allowed directories")
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories') as mock_bases:
    ...
    def test_url_validation_code_exists(self, client, admin_user, test_game):
        ...
        from gametheca.routes_games_ext.edit import game_edit
        import inspect
    ...
    def test_security_functions_imported(self, client, admin_user, test_game):
        ...
        from gametheca.routes_games_ext import edit
    ...
    def test_url_validation_allows_valid_https(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', return_value=1024):
                    with patch('gametheca.routes_games_ext.edit.read_first_nfo_content', return_value='NFO'):
                        response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
...
class TestGameEditErrorHandling:
    ...
    def test_scan_job_running_blocks_edit(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_scan_job_running', return_value=True):
            response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
    ...
    def test_file_operation_error_handling(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', side_effect=OSError("Permission denied")):
                    response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
    ...
    def test_configuration_error_handling(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=[]):
            response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
...
class TestGameEditLogging:
    ...
    def test_security_logging_for_path_validation(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path') as mock_safe_path:
            ...
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.current_app.logger') as mock_logger:
                    response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
    ...
    def test_audit_logging_for_successful_update(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', return_value=1024):
                    with patch('gametheca.routes_games_ext.edit.read_first_nfo_content', return_value='NFO'):
                        with patch('gametheca.routes_games_ext.edit.log_system_event') as mock_log:
                            response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
    ...
    def test_secure_path_logging(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', return_value=1024):
                    with patch('gametheca.routes_games_ext.edit.read_first_nfo_content', return_value='NFO'):
                        with patch('gametheca.routes_games_ext.edit.sanitize_path_for_logging') as mock_sanitize:
                            with patch('gametheca.routes_games_ext.edit.current_app.logger') as mock_logger:
...
class TestGameEditSuccessScenarios:
    ...
    def test_successful_game_update(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', return_value=2048000):
                    with patch('gametheca.routes_games_ext.edit.read_first_nfo_content', return_value='Updated NFO'):
                        response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
...
class TestGameEditDatabaseOperations:
    ...
    def test_game_size_calculation_updated(self, client, admin_user, test_game, form_data):
        ...
        with patch('gametheca.routes_games_ext.edit.is_safe_path', return_value=(True, None)):
            with patch('gametheca.routes_games_ext.edit.get_allowed_base_directories', return_value=['/allowed']):
                with patch('gametheca.routes_games_ext.edit.get_folder_size_in_bytes_updates', return_value=new_size):
                    with patch('gametheca.routes_games_ext.edit.read_first_nfo_content', return_value='New NFO'):
                        response = client.post(f'/game_edit/{test_game.uuid}', data=form_data)
