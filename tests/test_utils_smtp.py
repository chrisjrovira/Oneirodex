...
from gametheca.utils.smtp import (
...
class TestIsSMTPConfigValid:
    ...
    @patch('gametheca.utils.smtp.get_smtp_settings')
...
class TestIsServerReachable:
    ...
    @patch('gametheca.utils.smtp.socket.create_connection')
    ...
    @patch('gametheca.utils.smtp.socket.create_connection')
    @patch('gametheca.utils.smtp.smtplib.SMTP')
    @patch('ssl.create_default_context')
...
class TestSendEmail:
    ...
    @patch('gametheca.utils.smtp.log_system_event')
    @patch('gametheca.utils.smtp.flash')
    @patch('gametheca.utils.smtp.get_smtp_settings')
    ...
    @patch('gametheca.utils.smtp.log_system_event')
    @patch('gametheca.utils.smtp.flash')
    @patch('gametheca.utils.smtp.is_smtp_config_valid')
    @patch('gametheca.utils.smtp.get_smtp_settings')
    ...
    @patch('gametheca.utils.smtp.log_system_event')
    @patch('gametheca.utils.smtp.flash')
    @patch('gametheca.utils.smtp.is_server_reachable')
    @patch('gametheca.utils.smtp.is_smtp_config_valid')
    @patch('gametheca.utils.smtp.get_smtp_settings')
    ...
    @patch('gametheca.utils.smtp.traceback.format_exc')
    @patch('gametheca.utils.smtp.log_system_event')
    @patch('gametheca.utils.smtp.flash')
    @patch('gametheca.utils.smtp.smtplib.SMTP')
    @patch('gametheca.utils.smtp.is_server_reachable')
...
class TestSendPasswordResetEmail:
    ...
    @patch('gametheca.utils.smtp.send_email')
    @patch('gametheca.utils.smtp.url_for')
...
class TestSendInviteEmail:
    ...
    @patch('gametheca.utils.smtp.send_email')
    @patch('gametheca.utils.smtp.render_template')
