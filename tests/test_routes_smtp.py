...
class TestSmtpContextProcessor:
    ...
    @patch('gametheca.routes_smtp.get_global_settings')
    def test_inject_settings_cached(self, mock_get_settings, app):
        ...
        with app.app_context():
            from gametheca.routes_smtp import inject_settings
...
class TestSmtpSettings:
    ...
    def test_get_requires_login(self, client, admin_user):
        ...
        from gametheca.utils.setup import mark_setup_complete
        mark_setup_complete()
    ...
    @patch('gametheca.routes_smtp.render_template')
    ...
    def test_post_database_commit_error(self, client, admin_user, db_session):
        ...
        with patch('gametheca.routes_smtp.db.session.commit', side_effect=Exception('Database error')):
            response = client.post('/admin/smtp_settings', json=data)
...
class TestSmtpTest:
    ...
    @patch('gametheca.routes_smtp.SMTPTester')
