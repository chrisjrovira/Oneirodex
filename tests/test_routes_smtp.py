...
class TestSmtpContextProcessor:
    ...
    @patch('oneirodex.routes_smtp.get_global_settings')
    def test_inject_settings_cached(self, mock_get_settings, app):
        ...
        with app.app_context():
            from oneirodex.routes_smtp import inject_settings
...
class TestSmtpSettings:
    ...
    @patch('oneirodex.routes_smtp.render_template')
    ...
    def test_post_database_commit_error(self, client, admin_user, db_session):
        ...
        with patch('oneirodex.routes_smtp.db.session.commit', side_effect=Exception('Database error')):
            response = client.post('/admin/smtp_settings', json=data)
...
class TestSmtpTest:
    ...
    @patch('oneirodex.routes_smtp.SMTPTester')
