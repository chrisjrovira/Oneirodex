...
from gametheca.utils.scanning import (
...
class TestTryAddGame:
    ...
    @patch('gametheca.utils.game_core.retrieve_and_save_game')
...
class TestProcessGameUpdates:
    ...
    def test_process_game_updates_success(self, mock_isdir, 
        ...
        with patch('os.listdir', side_effect=listdir_side_effect), \
             patch('gametheca.utils.scanning.read_first_nfo_content', return_value='Test NFO content'):
...
class TestRefreshImagesInBackground:
    ...
    @patch('gametheca.utils.scanning.delete_game_images')
    @patch('gametheca.utils.game_core.process_and_save_image')
    @patch('gametheca.utils.scanning.make_igdb_api_request')
