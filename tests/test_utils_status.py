...
from oneirodex.utils.status import (
    get_system_info,
    get_config_values,
    get_active_users,
    get_log_info,
...
class TestGetSystemInfo:
    ...
    @patch('oneirodex.utils.status.socket.gethostbyname')
    @patch('oneirodex.utils.status.socket.gethostname')
    @patch('oneirodex.utils.status.platform.python_version')
    @patch('oneirodex.utils.status.platform.version')
    @patch('oneirodex.utils.status.platform.system')
...
class TestGetConfigValues:
    ...
    @patch('oneirodex.utils.status.os.path.exists')
    @patch('oneirodex.utils.status.os.access')
    def test_get_config_values_with_existing_paths(self, mock_access, mock_exists):
        ...
        with patch('oneirodex.utils.status.Config') as mock_config:
