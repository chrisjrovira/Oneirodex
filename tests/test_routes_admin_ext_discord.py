"""
Unit tests for gametheca.routes_admin_ext.discord
...
class TestDiscordSettings:
    ...
    @patch('gametheca.routes_admin_ext.discord.validate_discord_webhook_url')
    @patch('gametheca.routes_admin_ext.discord.validate_discord_bot_name')
    @patch('gametheca.routes_admin_ext.discord.validate_discord_avatar_url')
    ...
    def test_discord_settings_post_handles_database_error(self, mock_avatar_val, mock_name_val, mock_webhook_val, client, admin_user, db_session):
        ...
        with patch('gametheca.routes_admin_ext.discord.db.session.commit', side_effect=Exception("Database error")):
            response = client.post('/admin/discord_settings', data={
                'discord_webhook_url': 'https://discord.com/api/webhooks/123/test',
                'discord_bot_name': 'Test Bot',
                'discord_bot_avatar_url': ''
...
class TestTestDiscordWebhook:
    ...
    @patch('gametheca.routes_admin_ext.discord.validate_discord_bot_name')
    @patch('gametheca.routes_admin_ext.discord.validate_discord_avatar_url')
    @patch('gametheca.routes_admin_ext.discord.DiscordWebhookHandler')
    ...
    def test_test_discord_webhook_empty_strings_handled(self, client, admin_user):
        ...
        with patch('gametheca.routes_admin_ext.discord.validate_discord_webhook_url') as mock_webhook_val:
