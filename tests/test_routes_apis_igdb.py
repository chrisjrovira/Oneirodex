...
from gametheca.models import User, Game, Library
...
class TestGetCoverThumbnail:
    ...
    @patch('gametheca.routes_apis.igdb.get_cover_thumbnail_url')
...
class TestCheckIgdbId:
    ...
    @patch('gametheca.routes_apis.igdb.check_existing_game_by_igdb_id')
