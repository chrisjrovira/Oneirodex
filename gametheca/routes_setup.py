...
def setup():
    from gametheca.utils.setup import is_setup_in_progress, get_setup_redirect_url
...
def setup_igdb():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            from gametheca.init_data import initialize_library_folders, insert_default_scanning_filters, initialize_default_settings, initialize_allowed_file_types, initialize_discovery_sections
