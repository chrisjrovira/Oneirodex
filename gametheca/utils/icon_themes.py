...
``pack.css``. CSS uses ``currentColor`` so packs work with any ``--gt-*`` theme.
"""
...
""",
    'filled': """
html[data-icon-pack="filled"] .gt-icon {
  stroke-width: 1.25;
  fill: currentColor;
  fill-opacity: 0.92;
  stroke-opacity: 0.35;
}
html[data-icon-pack="filled"] .gt-icon [fill="currentColor"] {
  fill-opacity: 1;
}
""",
    'duotone': """
html[data-icon-pack="duotone"] .gt-icon {
  stroke-width: 1.75;
  fill: currentColor;
  fill-opacity: 0.22;
}
html[data-icon-pack="duotone"] .gt-icon [fill="currentColor"] {
  fill-opacity: 0.55;
}
""",
    'pixel': """
html[data-icon-pack="pixel"] .gt-icon {
  stroke-width: 2.75;
...
""",
    'soft': """
html[data-icon-pack="soft"] .gt-icon {
  stroke-width: 1.35;
...
""",
    'mono': """
html[data-icon-pack="mono"] .gt-icon {
  stroke-width: 0.5;
  fill: currentColor;
  fill-opacity: 1;
  stroke: currentColor;
...
html[data-icon-pack="mono"] .gt-icon [fill="none"] {
  fill: currentColor;
}
""",
}
...
def install_icon_themes(*, force: bool = False) -> list[str]:
    """Install builtin icon packs into static/library/icon-themes."""
    root = icon_themes_root()
    root.mkdir(parents=True, exist_ok=True)
    installed: list[str] = []
    source = setup_icon_themes_source()
    if source.is_dir():
