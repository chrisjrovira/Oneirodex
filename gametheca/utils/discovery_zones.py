...
routes (gametheca/routes_admin_ext/system.py) and the member Discover feed
(gametheca/routes_discover.py) stay in sync.
"""
...
from gametheca.models import Game, Genre, Library
