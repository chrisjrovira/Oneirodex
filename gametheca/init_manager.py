...
def is_initialization_complete():
    ...
    if os.getenv('GAMETHECA_INITIALIZATION_COMPLETE') == 'true':
        return True
...
def mark_initialization_complete():
    ...
    os.environ['GAMETHECA_INITIALIZATION_COMPLETE'] = 'true'
    os.environ['GAMETHECA_MIGRATIONS_COMPLETE'] = 'true'
