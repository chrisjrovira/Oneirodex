...
// Prefer admin-uploaded BIOS under GameTheca static; missing files fail soft (biosReady still set).
var biosCdn = "/static/library/bios/";
var infoJsonUrl = "/static/vendor/webretro/assets/info.json";
...
// GameTheca A/V tuning: WASM audio scheduling (Web Audio + emscripten main
// thread) is jitterier than native, so a slightly larger buffer + wider
...
// Cabinet playback (rewind / FF / sharp pixels) is appended here so it wins
...
// GameTheca: prefer GT_INSTALLED_CORES from /api/emulator/installed-cores.js (disk-backed).
