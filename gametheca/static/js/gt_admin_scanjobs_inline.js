 ...
 * <script>. Lives under static/js, not a theme copy — no Reset Themes. */
    ...
    const ICON_DOWNLOAD_SVG = (document.getElementById('gt-icon-download') || {}).innerHTML || '';
    const ICON_TRASH_SVG = (document.getElementById('gt-icon-trash') || {}).innerHTML || '';
