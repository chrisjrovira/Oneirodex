...
(function (global) {
  ...
  var MARKUP = {
    dpad:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><rect class="gt-loading-motif__pad" x="18" y="8" width="12" height="32" rx="2"></rect><rect class="gt-loading-motif__pad" x="8" y="18" width="32" height="12" rx="2"></rect><circle class="gt-loading-motif__dpad-press" cx="24" cy="13" r="3"></circle><circle class="gt-loading-motif__dpad-press gt-loading-motif__dpad-press--r" cx="35" cy="24" r="3"></circle><circle class="gt-loading-motif__dpad-press gt-loading-motif__dpad-press--d" cx="24" cy="35" r="3"></circle><circle class="gt-loading-motif__dpad-press gt-loading-motif__dpad-press--l" cx="13" cy="24" r="3"></circle></svg>',
    disc:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><g class="gt-loading-motif__platter"><circle class="gt-loading-motif__disc-edge" cx="24" cy="24" r="15"></circle><path class="gt-loading-motif__disc-glint" d="M24 9a15 15 0 0 1 13 7.5"></path></g><circle class="gt-loading-motif__disc-hub" cx="24" cy="24" r="4"></circle><rect class="gt-loading-motif__head" x="23" y="30" width="2" height="12" rx="1"></rect></svg>',
    stick:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><circle class="gt-loading-motif__gate" cx="24" cy="24" r="15"></circle><g class="gt-loading-motif__stick"><circle class="gt-loading-motif__stick-cap" cx="24" cy="24" r="7"></circle></g></svg>',
    handheld:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><rect class="gt-loading-motif__shell" x="12" y="6" width="24" height="36" rx="3"></rect><rect class="gt-loading-motif__screen" x="16" y="11" width="16" height="13" rx="1"></rect><rect class="gt-loading-motif__scanline" x="16" y="12" width="16" height="2"></rect><circle class="gt-loading-motif__led" cx="16.5" cy="28.5" r="1.5"></circle><rect class="gt-loading-motif__pad" x="17" y="32" width="7" height="2.2" rx="1"></rect><rect class="gt-loading-motif__pad" x="19.4" y="29.6" width="2.2" height="7" rx="1"></rect></svg>',
    cart:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><path class="gt-loading-motif__slot" d="M11 30h26v10H11z"></path><g class="gt-loading-motif__cart"><rect class="gt-loading-motif__cart-body" x="15" y="8" width="18" height="20" rx="2"></rect><rect class="gt-loading-motif__cart-label" x="18" y="11" width="12" height="7" rx="1"></rect><path class="gt-loading-motif__cart-pins" d="M18 25h12"></path></g></svg>',
    crt:
      '<svg viewBox="0 0 48 48" aria-hidden="true"><rect class="gt-loading-motif__tube" x="7" y="10" width="34" height="24" rx="4"></rect><rect class="gt-loading-motif__raster" x="10" y="13" width="28" height="4"></rect><path class="gt-loading-motif__stand" d="M19 34v4h10v-4M15 38h18"></path></svg>'
  };
  ...
  function showBlocking(message) {
    ...
    host.className = 'gt-loading-overlay gt-loading-overlay--blocking';
    ...
    if (message) {
      ...
      label.className = 'gt-loading-overlay__label';
   ...
   * roughly forty-seven Jinja pages kept the plain `.gt-spinner`. Built, and
   * never switched on.
   *
   ...
   * `.gt-spinner` inside a button is a 14px inline mark, and swapping that for
