document.addEventListener('DOMContentLoaded', function() {
    ...
    function setSelectedMultiValues(selectId, values) {
        const select = document.getElementById(selectId);
        if (!select) return;
    ...
    function selectedLibraryUuids() {
        return selectedMultiValues('editAllowedLibraries');
    }

    function setSelectedLibraryUuids(uuids) {
        setSelectedMultiValues('editAllowedLibraries', uuids);
    }

    function syncAllowlistVisibility() {
        const role = document.getElementById('editRole')?.value;
        const show = role === 'child';
        ;['editLibraryAllowlistWrap', 'editDeniedGenresWrap', 'editDeniedThemesWrap'].forEach((id) => {
    ...
    document.getElementById('editRole')?.addEventListener('change', syncAllowlistVisibility);
    ...
    document.getElementById('saveUserChanges').addEventListener('click', function() {
        ...
        const userData = {
            ...
            allowed_library_uuids: selectedLibraryUuids(),
            denied_genres: selectedMultiValues('editDeniedGenres'),
            denied_themes: selectedMultiValues('editDeniedThemes'),
        };
    ...
    function fetchUserDetails(userId) {
        fetch(`/admin/api/user/${userId}`)
            ...
            .then(data => {
                ...
                setSelectedLibraryUuids(data.allowed_library_uuids || []);
                setSelectedMultiValues('editDeniedGenres', data.denied_genres || []);
                setSelectedMultiValues('editDeniedThemes', data.denied_themes || []);
