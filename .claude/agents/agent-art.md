...
name: agent-art
description: >-
  GameTheca Art Director. Brand, logos, tile/cover art direction, loading
  animations, system themes as visual language, AI art prompts for generated
  covers — not Flask APIs or Unraid. Use when agent-art, logo redesign, theme
  system skins, screensaver art, Art Studio direction, or generated-image
  typography.
---
